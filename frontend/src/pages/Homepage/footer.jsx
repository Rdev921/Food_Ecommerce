...
import { faFacebook,faSlack,faTwitter,faInstagram,faLinkedin,faYoutube, } from "@fortawesome/free-brands-svg-icons";
...
<Link to="https://course.masaischool.com/dashboard"> <FontAwesomeIcon icon={faYoutube}/></Link>
</div>
</div>
<hr/>
...
<ul class="box">
    ...
    <li><Link to="#">FoodHub's Vision</Link></li>
    <li><Link to="#">Test Kitchen</Link></li>
...
<ul class="box">
    ...
    <li><Link to="#">FoodHub Trade</Link></li>
...
<li><input type="button" value="Subscribe"/></li>
  ...
  <div class="bottom-details">
    <div class="bottom-text">
        <span class="copyright-text">Copyright & #915; June,2023 <Link to="#">FoodHub.</Link>All rights are reserved</span>
